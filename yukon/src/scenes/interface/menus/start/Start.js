...
export default class Start extends BaseScene {
    ...
    create() {
        ...
        // blogButton (components) - commented out
        ...
        // memberButton (components) - commented out
