...
// Files that flag ALL services when changed
const GLOBAL_TRIGGERS = ['docker-compose.yml', '.env'];

function mapFileToServices(filePath) {
    const matched = [];
...
module.exports = { SERVICES, GLOBAL_TRIGGERS, mapFileToServices };
