...
export default class Join extends GamePlugin {
    ...
    async joinServer(args, user) {
        console.log('[DEBUG] joinServer: START')
        console.log('[DEBUG] joinServer: user.inventory =', user.inventory)
        console.log('[DEBUG] joinServer: user.igloos =', user.igloos)
        ...
        console.log('[DEBUG] joinServer: load_player sent')
        ...
        console.log('[DEBUG] joinServer: token handled')

        let spawn = this.getSpawn()
        console.log('[DEBUG] joinServer: spawn room =', spawn?.id)

        user.joinRoom(spawn)
        console.log('[DEBUG] joinServer: joinRoom called')

        user.joinedServer = true
        await this.handler.updateWorldPopulation()
        console.log('[DEBUG] joinServer: END')
    }
